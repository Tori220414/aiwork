...
const CalendarSettings: React.FC = () => {
  ...
  const handleConnectGoogle = () => {
    ...
    if (!clientId) {
      toast.error(
        'Google Calendar integration not configured. Please contact administrator to set up Google OAuth.',
        { duration: 5000 }
      );
      return;
    }
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Sync your tasks with Google Calendar and import events
              </p>
        ...
        {googleStatus.connected && (
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-3">
              <label className="flex items-center">
                <input type="checkbox" defaultChecked className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                <span className="ml-2 text-sm text-gray-700">Automatically sync new tasks to Google Calendar</span>
              </label>
              <label className="flex items-center">
                <input type="checkbox" defaultChecked className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                <span className="ml-2 text-sm text-gray-700">Import Google Calendar events as tasks</span>
              </label>
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                <span className="ml-2 text-sm text-gray-700">Sync task completions back to Google Calendar</span>
              </label>
            </div>
          </div>
        )}
